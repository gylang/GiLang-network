...
public class NettyWebsocketInitializer extends ChannelInitializer<SocketChannel> implements AfterNetWorkContextInitialized {
    ...
    private NettyWebsocketRouterInboundHandler webNettySocketRouterInboundHandler;
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast("heart", new NettyWebsocketHeartCheckHandler(serverContext));
    ...
    public void post(ServerContext serverContext) {
        ...
        this.webNettySocketRouterInboundHandler = serverContext.getBeanFactoryContext().getPrimaryBean(NettyWebsocketRouterInboundHandler.class);
